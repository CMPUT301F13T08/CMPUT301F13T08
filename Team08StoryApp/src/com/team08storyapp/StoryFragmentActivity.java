...
public class StoryFragmentActivity extends Activity {
    ...
    /**
     * showPopup method sets up the popup menu and its menu item's click
     * listener.
     * 
     */
    ...
    /**
     * onActivityResult handles the results from adding annotations from
     * gallery/ camera: save the photo, update the story.
     */
