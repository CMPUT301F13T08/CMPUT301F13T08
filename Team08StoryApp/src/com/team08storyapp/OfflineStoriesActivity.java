...
public class OfflineStoriesActivity extends ListActivity {
	...
	private Story initializeSampleStory() {
		...
		choices.clear();
		choices.add(new Choice(4, 4, "In the bush, Amara found a small boy."));
		choices.add(new Choice(5, 5,
		...
		choices.clear();
		choices.add(new Choice(8, 6,
				"Amara decides to take a peek in the cave."));
		choices.add(new Choice(9, 7,
		...
		choices.clear();
		choices.add(new Choice(10, 8,
				"Amara decides to help the boy find his way home."));
		choices.add(new Choice(11, 9, "Amara is uncertain what to do."));
		...
		choices.clear();
		choices.add(new Choice(6, 10, "Continue"));
		storyFragment5.setChoices(choices);
		storyFragmentList.add(storyFragment5);

		// Story Fragment 6
		StoryFragment storyFragment6 = new StoryFragment(6);
		storyFragment6.setStoryText("When Amara got to her friend's house she explained her excitement at finding one hundred dollars in a bush, all thanks to her dog. Her friend suggests she should reward her dog a treat with part of the money.");

		choices.clear();
		choices.add(new Choice(7, 11, "Continue"));
		...
		choices.clear();
		choices.add(new Choice(4, 12, "Continue"));
		...
		choices.add(new Choice(12, 13, "Continue"));
